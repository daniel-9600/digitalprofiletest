...
// Step 2: Pulling out your wallet to pay but it's not enough.
        automatedInput.append("1\n"); // The choice you made, then you pull out your wallet to see..
        automatedInput.append("9\n"); // That the money you hold are insufficient for the Gym Membership.
// Step 3: Pulling out your wallet to pay AND it's enough.
        automatedInput.append("1\n"); // The choice you made, then you pull out your wallet to see..
        automatedInput.append("9\n"); // That the money you hold ARE sufficient for the Gym Membership.
// Step 4: Met the Gym worker, and asks if you have guts to buy a gym membership BUT you don't actually have the guts.
        automatedInput.append("2\n"); // Instigated by the Gym worker, but you chose to decline the offer.
// Step 5: Met the Gym worker, and asks if you have guts to buy a gym membership BUT you're just a wuss.
